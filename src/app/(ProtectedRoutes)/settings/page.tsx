...
const Settings = async (props: Props) => {
    ...
    <div className='w-full mx-auto py-8 px-4'>
        ...
        <div className='w-full p-6 border border-input rounded-lg bg-background shadow-sm'>
         ...
         <div className='my-6 p-4 bg-muted rounded'>
...
{isConnected ? "You can now accept payments through your application" : "Connect your stripe account to start processing payments and managing subscriptions."}
</p>
...
<Link
href={stripeLink}
className={`px-5 py-2.5 rounded-md font-medium text-sm flex items-center gap-2 transition-colors ${isConnected ? 'bg-muted hover:bg-muted/80 text-foreground' : 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white'}`}
>
